    ...
    <div className="mb-4">
      ...
      {open && (
        <div className="mt-3 rounded-lg border bg-card p-4 space-y-4 animate-in slide-in-from-top-2">
          <div>
            <p className="text-sm font-medium text-foreground mb-2">Exclude allergens</p>
          ...
          <div>
            <p className="text-sm font-medium text-foreground mb-2">Calories: {calorieRange[0]} – {calorieRange[1]} kcal</p>
            <Slider
              min={0}
              max={2000}
              step={50}
